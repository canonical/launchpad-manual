...
-  `Registering your project <projects/registering-project>`__ in Launchpad.
-  `Enabling commercial features <CommercialHosting>`__ for your project
-  `Planning and recording
   releases <projects/series-milestones-releases>`__.
-  `Making your project files available for
   download <projects/publishing-files>`__.
-  `Publishing project announcements <Projects/Announcements>`__.
-  `Closing a project <projects/closing-project>`__.
