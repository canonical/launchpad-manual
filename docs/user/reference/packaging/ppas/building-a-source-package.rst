...
you can copy the existing binaries to the new series; see :ref:`copying-packages`, and use the "Copy existing binaries" option.
...
described in the Ubuntu packaging guide's section on the `changelog file <http://packaging.ubuntu.com/html/debian-dir-overview.html#the-changelog>`_.
...
Now that you have a source package, you need to :ref:`upload it <upload-a-package-to-a-ppa>`!
