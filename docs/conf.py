...
# Set the URL prefix so sphinx-notfound-page resolves static assets correctly
# when the docs are served from a subdirectory path.
# sphinx-notfound-page will automatically use 404.rst if it exists.

notfound_urls_prefix = "/docs/launchpad/"
