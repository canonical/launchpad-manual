...
<https://canonical.com/lxd/docs/latest/>`_-managed container. You can 
...
The development LXD container that runs Launchpad requires
Ubuntu 20.04 LTS with Python 3.8. Ubuntu 22.04 is known not
to work yet.
