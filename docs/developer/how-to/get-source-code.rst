...
Launchpad's source code exists in a Git repository, and you can clone it using
Git.

Please note that currently Launchpad can only be built and run on Ubuntu 20.04
LTS or newer.
...
If you launch a production server, it needs to look different and have a
different name, since 'Launchpad' is a trademark.
...
For any :ref:`help <get-help>`, please reach out to the Launchpad team.
